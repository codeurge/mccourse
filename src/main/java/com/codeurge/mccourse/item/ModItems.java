...
import com.codeurge.mccourse.util.Registration;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> COPPER_INGOT =
            Registration.ITEMS.register("copper_ingot",
                    () -> new CopperIngot(new Item.Properties().group(MCCourseMod.COURSE_TAB))
            );
    ...
    public static final RegistryObject<Item> UNLIMITED_DIAMOND =
            Registration.ITEMS.register("unlimited_diamond",
                    () -> new UnlimitedDiamond(new Item.Properties().group(MCCourseMod.COURSE_TAB)));

    public static final RegistryObject<Item> COPPER_APPLE =
            Registration.ITEMS.register("copper_apple", CopperApple::new);
